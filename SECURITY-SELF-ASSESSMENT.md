...
| Creator           | open-nudge                                                                                         |
| Software          | [https://github.com/open-nudge/pratidoc](https://github.com/open-nudge/pratidoc)                   |
| Website           | [https://open-nudge.github.io/pratidoc](https://open-nudge.github.io/pratidoc)                     |
| Security Provider | No                                                                                                 |
| Languages         | Python                                                                                             |
| SBOM              | [https://github.com/open-nudge/pratidoc/releases](https://github.com/open-nudge/pratidoc/releases) |

### Security links

| Category          | Resource                                                                                                                                         |
| ----------------- | ------------------------------------------------------------------------------------------------------------------------------------------------ |
| Security File     | [https://github.com/open-nudge/pratidoc/blob/main/SECURITY.md](https://github.com/open-nudge/pratidoc/blob/main/SECURITY.md)                     |
| Security Insights | [https://github.com/open-nudge/pratidoc/blob/main/SECURITY-INSIGHTS.yml](https://github.com/open-nudge/pratidoc/blob/main/SECURITY-INSIGHTS.yml) |
| Dependencies      | [https://github.com/open-nudge/pratidoc/blob/main/pyproject.toml](https://github.com/open-nudge/pratidoc/blob/main/pyproject.toml)               |
| Release Artifacts | [https://github.com/open-nudge/pratidoc/releases](https://github.com/open-nudge/pratidoc/releases)                                               |
...
| --------- | ------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| template  | Critical      | Base GitHub template of the repository provided by `opennudge`. Used to provide initial security posture (pipelines, pre-commit, practices, hardening etc.) See [open-nudge/pratidoc](https://github.com/open-nudge/pratidoc) for more information |
...
The [`open-nudge/pratidoc`](https://github.com/open-nudge/pratidoc)
security policy is maintained in the
[`SECURITY.md`](https://github.com/open-nudge/pratidoc/blob/master/SECURITY.md)
file.
...
[`SECURITY.md`](https://github.com/open-nudge/pratidoc/blob/master/SECURITY.md#reporting-a-vulnerability.)
file.
