...
- To learn more about using this project, see the
    [__documentation__](https://open-nudge.github.io/pratidoc).
- To discuss the project, you can join the
    [__discussions__](https://github.com/open-nudge/pratidoc/discussions).
    and follow the provided template.
- To report a bug or request a feature, you can
    [__open an issue__](https://github.com/open-nudge/pratidoc/issues)
    and follow the provided template.
