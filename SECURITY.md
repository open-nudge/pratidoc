...
- [Security Insights Specification](https://github.com/open-nudge/pratidoc/blob/main/SECURITY-INSIGHTS.yml)
...
- [Renovate Bot](https://github.com/open-nudge/pratidoc/blob/main/.github/renovate.json)
    for automated dependency updates
- [Software Bills Of Material (SBOMs)](https://github.com/open-nudge/pratidoc/releases)
- [Sigstore signing](https://github.com/open-nudge/pratidoc/releases)
