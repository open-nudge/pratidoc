...
This policy describes how `pratidoc` maintainers
consume third-party packages.

## Scope

This policy applies to all `pratidoc` maintainers
and all third-party packages used in the `pratidoc`
project.

## Policy

`pratidoc` contributors must follow these guidelines
...
When adding a new third-party package to `pratidoc`,
